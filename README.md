...
$narendra = [
    ...
    'specialty'   => ['WordPress', 'WooCommerce', 'ReactJS', 'NextJS'],
    'passion'     => ['☕ Coffee', '⚡ Clean Code'],
    'motto'       => 'Eat · Sleep · <Code> · Repeat',
    'open_to'     => 'Collaboration & freelance WordPress & WooCommerce work',
];
```

- 🔭 I build **WooCommerce plugins** & **WordPress** customizations
- 🌱 Contributor to **wordpress-develop** core
- 💬 Ask me about **PHP, WordPress, WooCommerce, ReactJS, NextJS, TypeScript**
